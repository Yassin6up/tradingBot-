import { type User, type InsertUser, type Trade, type Portfolio, type BotState, type StrategyType, type TradingMode, type AIDecision, type Position, trades, portfolioSettings, users, apiKeys, positions, aiLogs } from "@shared/schema";
